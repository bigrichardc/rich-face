...
function PostImage({image}) {
    ...
    return (
        <img className="social-card__post-image" src={image} />
    );
}


const SocialCard = ({ postTitle, postText, userName, postImage }) => {
        ...
        <div className="social-card">
            ...
            <div className="social-card__user-post">
                <div className="social-card__user-details">
                    <img src="../data/avatar.png" className="social-card__avatar-image" />
